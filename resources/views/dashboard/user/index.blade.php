...
@section('title')
	Dashboard Admin | Halaman Pengguna
@endsection
					...
					<tr class="hover:bg-gray-50">
						...
						<td class="px-4 py-3 align-middle">
							<div class="flex items-center justify-center gap-2">
								...
								<a href="{{ route('user.edit', $user->id_user) }}" class="hidden min-[1000px]:inline-flex items-center gap-1 rounded-lg bg-blue-500 px-3 py-1 text-xs text-white hover:bg-blue-600">
